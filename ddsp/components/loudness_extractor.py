...
class LoudnessExtractor(nn.Module):
    def __init__(self,
        ...
        self.smoothing_window = torch.hann_window(self.n_fft, dtype = torch.float32).to(self.device)
    ...
    def forward(self, z):
        ...
        # SLICED_SIGNAL = torch.fft.rfft(sliced_windowed_signal, 1, onesided = False)
