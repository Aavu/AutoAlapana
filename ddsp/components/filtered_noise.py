...
class FilteredNoise(nn.Module):
    ...
    def forward(self, z):
        ...
        ZERO_PHASE_FR_BANK = torch.view_as_complex(ZERO_PHASE_FR_BANK.view(-1, filter_coeff_length, 2))
        zero_phase_ir_bank = torch.fft.irfft(ZERO_PHASE_FR_BANK, dim=-1, n = filter_coeff_length * 2 - 1)
